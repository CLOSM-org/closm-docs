...
| Data | Periodically reset | Permanently stored |
...
Access to the test environment may require permissions. Contact your administrator if you cannot access.
:::
...
1. Enter **Name**
2. Enter **Postal/ZIP code** (Japan: `100-0001`, US: `12345`)
3. Select **State/Province** from dropdown
4. Enter **City** and **Address 1**

:::note[Shipping Country]
Shipping country is auto-set based on your cart items.
:::

### Step 9: Calculate Shipping

1. After entering address, click "**Calculate Shipping**"
2. Shipping methods and rates will be displayed
3. Select a shipping method (e.g., Standard)

### Step 10: Test Payment

1. Click "**Proceed to Payment**"
2. You'll be redirected to Stripe payment screen
